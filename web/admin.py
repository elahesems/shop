...
class ModifiedProduct(admin.ModelAdmin):
    list_display = ('name','price','currency','gender','inDate','status',)# extra fields in the admin
    list_filter = ('price','shoesSize','gender','size',) #filters
    search_fields = ('name','gender',) #bu alanlar üzerinde search yapılacaktır
